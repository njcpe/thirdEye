...
public class CodecManager {
	...
	static class Selector {
		...
		static private void findSupportedColorFormats(String mimeType) {
			...
			for (int i=0;i<softwareCodecs.size();i++) e.append(softwareCodecs.keyAt(i)).append(", ");
			for (int i=0;i<hardwareCodecs.size();i++) e.append(hardwareCodecs.keyAt(i)).append(i == hardwareCodecs.size() - 1 ? "." : ", ");
