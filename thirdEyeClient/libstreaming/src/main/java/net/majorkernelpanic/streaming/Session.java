...
public class Session {
	...
	public interface Callback {
		...
		/** 
		 * Called periodically to info	rm you on the bandwidth
	...
	public String getSessionDescription() {
		...
		sessionDescription.append("o=- ").append(mTimestamp).append(" ").append(mTimestamp).append(" IN IP4 ").append(mOrigin).append("\r\n");
		sessionDescription.append("s=Unnamed\r\n");
		sessionDescription.append("i=N/A\r\n");
		sessionDescription.append("c=IN IP4 ").append(mDestination).append("\r\n");
